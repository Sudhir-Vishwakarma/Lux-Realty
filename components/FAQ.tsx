...
const faqs = [
  ...
  {
    question: 'How does the buying process work at LuxeRealty?',
  ...
  },
  {
    ...
    answer: 'Yes. Every new project listed on LuxeRealty is verified for RERA registration under MahaRERA (Maharashtra Real Estate Regulatory Authority). You can cross-check any project using its RERA number on the MahaRERA website at maharera.mahaonline.gov.in. LuxeRealty itself is also registered as a real estate agent under MahaRERA.',
  },
  {
  ...
  {
    question: 'How can I become a Channel Partner with LuxeRealty?',
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500">
            Everything you need to know about buying, renting, selling, and partnering with LuxeRealty in Mumbai.
          </p>
        </div>
        ...
        <p className="text-center text-gray-500 text-sm mt-10">
          ...
          <a href="mailto:hello@luxerealty.com" className="text-blue-900 font-semibold hover:text-amber-500 transition-colors">
            Email us at hello@luxerealty.com
          </a>
        </p>
      </div>
    </section>
